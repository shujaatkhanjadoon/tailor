...
const GENDER_OPTIONS: { key: Gender; label: string; emoji: string; desc: string }[] = [
  ...
  if (!shopId) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center">
        ...
        <h2 className="text-lg font-bold text-slate-800 mb-2">Setup Pehle Karein</h2>
  ...
  if (savedId) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6 text-center">
        ...
        <h2 className="text-xl font-bold text-slate-800 mb-1">{savedName} — Save Ho Gaya!</h2>
        <p className="text-slate-500 text-sm mb-8">Gahak ki details save ho gayi hain</p>
        ...
        <div className="flex flex-col gap-3 w-full max-w-xs">
          ...
          <button
            onClick={() => {
              ...
              setGender('male'); setNotes(''); setErrors({})
            }}
      ...
      <header className="px-4 pt-12 lg:pt-6 pb-4 border-b border-slate-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Customer ki details bharein</p>
          </div>
        </div>
      </header>
      ...
      <div className="flex-1 px-4 pt-6 space-y-5">
        ...
        <div>
          ...
          <div className={cn(
            ...
            <span className="text-slate-500 text-sm font-medium flex-shrink-0">+92</span>
      ...
      <div className="px-4 pt-4">
        ...
        >
          {saving ? (
            ...
            name ? `${name} Ko Save Karein ✓` : 'Gahak Save Karein'
          )}
        </button>
      </div>
    </div>
