    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">
          Darzi Manager ke baare mein
        </h1>
        <p className="text-lg text-slate-500 max-w-2xl mx-auto leading-relaxed">
          Hum Pakistan ke chote aur medium tailor shops ke liye ek simple,
          powerful management tool bana rahe hain — jo offline bhi kaam kare
      ...
      <section className="bg-slate-50 py-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-slate max-w-none space-y-5 text-slate-600 leading-relaxed">
            ...
            <p>
              Darzi Manager is problem ka solution hai. Ek simple app jo tailor
              ki zindagi aasan kare — bina complicated training ke, bina internet
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              title: 'Data Safety',
              desc:  'Aapka data aapka hai. Hum sirf storage provide karte hain — kabhi sell nahi karte, kabhi share nahi karte. Offline-first matlab aapka data hamesha aapke paas.',
            },
            {
              icon:  Zap,
              color: 'bg-amber-100 text-amber-600',
              title: 'Fast & Lightweight',
              desc:  'Purane Android phones par bhi fast kaam kare. Low-end devices, slow internet — sab ka socha hai. PWA install ho jaye aur offline bhi chale.',
            },
            {
              icon:  Users,
              color: 'bg-green-100 text-green-600',
              title: 'For Every Tailor',
              desc:  'Solo tailor se le kar badi dukaan tak — Darzi Manager sab ke liye hai. Free plan hamesha free rahega.',
            },
            {
              icon:  Globe,
              color: 'bg-purple-100 text-purple-600',
              title: 'Pakistan-Centric',
              desc:  'Raast payments, Roman Urdu interface, Pakistani garment types, local WhatsApp integration — sab kuch Pakistan ke liye.',
            },
            {
              icon:  Scissors,
      ...
      <section className="py-20 max-w-3xl mx-auto px-6 text-center">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6">
          <p className="text-slate-600 text-sm leading-relaxed italic">
            ...
            Darzi Manager unhi jaise logon ke liye hai."
          </p>
          <p className="text-slate-400 text-xs mt-3 font-medium">— Darzi Manager Team</p>
        </div>
      </section>
      ...
      <section className="bg-slate-900 py-16 text-center px-6">
        ...
        <p className="text-slate-400 mb-8 max-w-md mx-auto">
          Aaj hi shuru karein — 14 din free, koi card nahi chahiye.
      ...
      <footer className="border-t border-slate-200 py-8 text-center text-sm text-slate-400">
        ...
        © 2026 MyDarzi · Made with ❤️ for Pakistan 🇵🇰
      </footer>
    </div>
  )
}