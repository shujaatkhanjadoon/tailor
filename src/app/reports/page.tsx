...
export default function ReportsPage() {
  ...
  const {
    ...
    statusDistribution, garmentBreakdown,
    topCustomers, karigarStats,
    paymentMethods, dailyActivity,
    isLoading,
  } = useReports(shopId)
      ...
      {isLoading ? (
        <div className="flex items-center justify-center py-20">
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-sm text-slate-400">Reports load ho rahi hain...</p>
          </div>
        </div>
      ) : (
        <main className="flex-1 px-4 pt-4 space-y-5">
          ...
          {activeTab === 'overview' && (
            <div className="space-y-4 pb-4">
                        ...
                        <div key={m.method}>
                          ...
                          <div className="h-2 bg-slate-100 rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width:      `${m.pct}%`,
                                background: m.method === 'cash'      ? '#22c55e' :
                                            m.method === 'easypaisa' ? '#14b8a6' :
                                            m.method === 'jazzcash'  ? '#ef4444' :
                                            m.method === 'bank'      ? '#3b82f6' : '#94a3b8',
                              }}
                            />
                          </div>
                        </div>
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-5">
                <h3 className="font-bold text-slate-800 mb-1">30-Day Activity</h3>
                <p className="text-xs text-slate-400 mb-4">
                    ...
                    {dailyActivity.map(day => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Tooltip on hover */}
                          <div className="absolute bottom-full mb-2 bg-slate-900 text-white
            ...
            <div className="space-y-4 pb-4">
              {karigarStats.length === 0 ? (
                <div className="bg-white border border-slate-200 rounded-2xl p-8 text-center">
                  ...
                  <p className="font-semibold text-slate-600">Koi karigar nahi</p>
