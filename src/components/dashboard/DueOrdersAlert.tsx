...
import { OrderRecord } from '@/lib/db/schema'     // ← use OrderRecord, not Order
import { useRouter } from 'next/navigation'

interface DueOrdersAlertProps {
  orders: OrderRecord[]                            // ← was Order[]
}
...
export function DueOrdersAlert({ orders }: DueOrdersAlertProps) {
  ...
  return (
    <button
      ...
      className="w-full flex items-center gap-3 bg-red-50 border border-red-200 rounded-2xl p-4
